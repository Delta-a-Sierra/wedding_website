...
type RegistryRepo interface {
	...
	GetRegistryItemsPageAll(context.Context, int, int) ([]entities.RegistryItem, error)
	GetRegistryItemsPageNotPurchased(context.Context, int, int) ([]entities.RegistryItem, error)
}
